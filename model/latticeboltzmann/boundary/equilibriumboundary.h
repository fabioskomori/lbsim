...
#ifndef EQUILIBRIUMBOUNDARY_H
#define EQUILIBRIUMBOUNDARY_H

#include "boundary.h"

class EquilibriumBoundary : public Boundary {
public:
    EquilibriumBoundary();
    ~EquilibriumBoundary();
    ...
    void setMultiComponentIndex(int multiComponentIndex);
...
private:
    ...
    int multiComponentIndex;
};

#endif // EQUILIBRIUMBOUNDARY_H
